...
export * as CollapsibleStep from '@/components/Checklist/CollapsibleStep'
...
interface ChecklistContentProps extends FlowChildrenProps, Pick<ChecklistProps, 'stepTypes'> {}
...
export function Checklist({ flowId, stepTypes = {}, ...props }: ChecklistProps) {
  return (
