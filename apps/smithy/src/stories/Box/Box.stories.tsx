...
export const StyleProps = {
  args: {
    children: (
      <Box  backgroundColor="blue500" color="primary.foreground" padding={3} borderBottomWidth="5px" borderBottomColor="blue" borderBottomStyle="solid" css={{ background: "pink" }}>
